...
const styleVariants = {
	default:
		{
			primary: "bg-[#211D1D] border-[#211D1D] text-[#FFFFFA] cursor-pointer hover:bg-[#FFFFFA] hover:border-[#211D1D] hover:text-[#211D1D]",
			secondary: "bg-[#FFFFFA] border-[#211D1D] text-[#211D1D] cursor-pointer hover:bg-[#211D1D] hover:border-[#211D1D] hover:text-[#FFFFFA]",
		},
