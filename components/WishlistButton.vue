...
const styleBase = "flex justify-center items-center px-2 py-1.5 rounded-lg border-[0.7px] border-transparent text-[13px]/snug font-[Manrope] sm:text-xs/snug " + (props.customClass ? props.customClass + ' ' : ' ')
const styleVariants = {
