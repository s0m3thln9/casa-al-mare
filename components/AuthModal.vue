...
<template>
  <div class="fixed inset-0 z-10 flex justify-center items-center">
    <div
	    class="w-[300px] bg-[#FFFFFA] border-[0.7px] border-[#211D1D] rounded-2xl"
    >
      ...
      <div class="px-6 pb-6 flex flex-col items-stretch">
        ...
        <template v-if="authStore.type === 'Авторизация'">
          <h2
	          class="mb-8 font-[Manrope] text-sm text-[#211D1D] text-center uppercase"
          >Вход</h2>
        ...
        <template v-else-if="authStore.type === 'Восстановление'">
          <h2
	          class="mb-4 font-[Manrope] text-sm text-[#211D1D] text-center uppercase"
          >Восстановление пароля</h2>
          <span
	          class="font-[Manrope] font-light text-sm text-[#414141] text-center mb-8"
        ...
        <template v-else-if="authStore.type === 'Успех восстановления'">
          <div class="flex flex-col items-center text-center">
            ...
            <span
	            class="font-[Manrope] font-light text-xs text-[#211D1D] mb-8"
        ...
        <template v-else>
          ...
          <template v-else>
            ...
            <span
	            class="font-[Commissioner] font-light text-[11px] text-[#8C8785] text-center mt-4"
            >
