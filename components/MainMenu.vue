...
<template>
  ...
  >
    <div
      class="max-h-[calc(100vh-32px)] sm:max-h-[calc(100vh-62px)] overflow-hidden absolute top-[32px] flex bg-[#FFFFFA] transition-all duration-300 h-full sm:top-[62px] sm:rounded-br-3xl sm:border-t-[0.5px] sm:border-r-[0.5px] sm:border-[#F9F6EC] sm:h-auto"
      :class="[
    ...
    >
      <div
        ...
        :class="[
          selectedSubmenu !== undefined && 'border-r-[0.5px] border-[#F9F6EC]',
          isMobile ? (selectedSubmenu !== undefined ? 'w-0' : 'px-2 pt-8 pb-6 w-full justify-between') : 'p-6 gap-6',
        ]"
      >
        <div
