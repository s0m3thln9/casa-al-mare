    ...
    <div class="px-2 sm:px-4 grid grid-cols-1 gap-10 items-start lg:grid-cols-[minmax(auto,618px)_1fr] lg:gap-20">
      <div class="flex flex-col items-center pt-4 lg:sticky lg:top-0 lg:h-screen">
        <div
          ...
          class="aspect-[618/570] w-full bg-[#F9F6EC] rounded-lg"
        />
        <img
          v-else
          :src="images.art1"
      ...
      <div class="max-w-[900px] flex flex-col gap-10 lg:gap-12">
        <div class="order-1">
          ...
          <p class="font-light text-sm mt-4">
            Значимость этих проблем настолько очевидна, что реализация намеченных плановых заданий в значительной
            степени обуславливает создание модели развития. Значимость этих проблем настолько очевидна, что начало
            повседневной работы по формированию позиции в значительной степени обуславливает создание позиций,
            занимаемых участниками в отношении поставленных задач. Задача организации, в особенности же рамки и место
            обучения кадров позволяет оценить значение соответствующий условий активизации. Товарищи! постоянное
            информационно-пропагандистское обеспечение нашей деятельности позволяет оценить значение соответствующий
            условий активизации. Равным образом начало повседневной работы по формированию позиции обеспечивает широкому
            кругу (специалистов) участие в формировании систем массового участия. С другой стороны постоянное
            информационно-пропагандистское обеспечение нашей деятельности представляет собой
            <span class="underline font-semibold sm:no-underline sm:font-light">интересный эксперимент</span> проверки
        ...
        <div class="order-5 sm:order-2">
          ...
          <div class="flex gap-2">
            ...
            <div>
              <h3 class="font-light text-[15px] sm:font-normal sm:text-base sm:uppercase">Подзаголовок</h3>
              <p class="font-light text-sm mt-2">
                Равным образом начало повседневной работы по формированию позиции обеспечивает широкому кругу
        ...
        <div class="order-3">
          <div
            v-if="!areImagesLoaded"
            class="aspect-[900/500] w-full bg-[#F9F6EC] rounded-lg"
          />
          <img
            v-else
            :src="images.art2"
        ...
        <div class="flex flex-col gap-6 order-2 sm:order-5">
          <div class="flex gap-2 max-w-[700px]">
            <div class="font-[Inter] text-[17px] min-w-8 sm:min-w-9 sm:text-2xl">1.</div>
            <div>
              <span class="font-light text-[15px] sm:font-normal sm:text-base sm:uppercase"
                >Равным образом начало повседневной работы по формированию позиции обеспечивает широкому кругу</span
              >
            </div>
          </div>
          <div class="flex gap-2 max-w-[700px]">
            ...
            <div>
              <span class="font-light text-[15px] sm:font-normal sm:text-base sm:uppercase"
                >С другой стороны постоянное информационно-пропагандистское обеспечение</span
              >
            </div>
          </div>
          <div class="flex gap-2 max-w-[700px]">
            ...
            <div>
              <span class="font-light text-[15px] sm:font-normal sm:text-base sm:uppercase"
                >Значимость этих проблем настолько очевидна, что начало повседневной работы</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-4 order-8">
          ...
          <div class="flex gap-2">
            ...
            <div>
              <span class="font-light text-sm"
                >С другой стороны постоянное информационно-пропагандистское обеспечение нашей деятельности представляет
                собой интересный эксперимент проверки направлений прогрессивного развития.</span
              >
            </div>
          </div>
          <div class="flex gap-2">
          ...
          <div class="flex gap-2">
            ...
            <div>
              <span class="font-light text-sm"
                >Равным образом начало повседневной работы по формированию позиции обеспечивает широкому кругу
                (специалистов) участие в формировании систем массового участия.</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="order-10">
          <p class="font-light text-sm">
            ...
            <span class="underline font-semibold sm:no-underline sm:font-light">место обучения кадров</span> позволяет
            оценить значение соответствующий условий активизации.
          </p>
        </div>
        <div class="order-11">
          <button
            class="px-4 py-2 rounded-2xl border border-[#211D1D] bg-[#211D1D] text-[#FFFFFA] font-light text-sm sm:px-8 sm:font-normal"
          >
            Поделиться
          </button>
        </div>
