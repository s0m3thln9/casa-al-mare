...
const breadcrumbsItems: { name: string, path?: string }[] = [
	{ name: "Главная", path: "/" },
	{ name: "Сертификат" }
]
    ...
    <div class="px-0 grid grid-cols-1 sm:grid-cols-[auto_1fr] gap-8 sm:px-4">
      ...
      <div class="px-2 flex flex-col sm:px-0">
        ...
        <div class="mt-14 flex flex-col justify-center items-center">
          ...
          <div :class="['flex justify-center items-center font-light sm:font-normal', ((certificateStore.step === 3) || (certificateStore.step === 2 && (certificateStore.selectedWay === 'Электронной почтой' || certificateStore.selectedWay === 'По SMS'))) ? 'flex-col' : 'gap-3 sm:gap-4']">
            ...
            <div
	            ...
	            :class="certificateStore.step === 2 && (certificateStore.selectedWay === 'Электронной почтой' || certificateStore.selectedWay === 'По SMS') && 'w-full'"
            >
              <SingleSelectButton
	              ...
	              :content="details"
              />
	            <div v-if="certificateStore.step === 2 && (certificateStore.selectedWay === 'Электронной почтой' || certificateStore.selectedWay === 'По SMS')" class="w-full flex flex-col">
	              <AppInput
