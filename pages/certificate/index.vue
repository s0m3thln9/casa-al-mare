...
useHead({
  title: "Сертификаты - CASA AL MARE",
})
...
"
        ...
        <div class="w-full mt-14">
          <CollapsibleBlock
            ...
            description="Этот сертификат — ваш билет в коллекцию CASA AL MARE. Дарите возможность выбрать то, что по-настоящему нравится.

Можно отправить анонимно или с указанием отправителя, дополнить персонализированным посланием — как захочется вам. Ваши слова — как открытка на закате.

Сертификатом можно оплатить всю сумму заказа или её часть. Если сумма покупки больше — доплатите разницу удобным способом. Чтобы использовать сертификат, введите уникальный код при оформлении заказа.

Баллы и промокоды не распространяются на покупку сертификата.
