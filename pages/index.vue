...
<template>
  <main class="bg-[#FFFFFA]">
    ...
    />
    <div
	    class="flex flex-col lg:flex-row gap-2 px-2 py-2 sm:gap-4 sm:px-4 sm:py-4"
    >
      <BannerCard
    ...
    <div
	    class="grid grid-cols-2 gap-2 px-2 sm:gap-4 md:grid-cols-6 lg:grid-cols-5 sm:px-4"
    >
      <BannerCard
    ...
    <AppSEO
	    :paragraphs="['— это бренд стильного белья и купальников, созданный для женщин, которые ценят комфорт, эстетику и качество.\n'+
'Мы разрабатываем коллекции, вдохновлённые природой, искусством и городским ритмом жизни.', 'В каталоге CASA AL MARE вы найдете:\n'+
